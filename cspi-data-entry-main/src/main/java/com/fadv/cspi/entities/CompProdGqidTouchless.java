...
public class CompProdGqidTouchless extends AuditModel {
	...
	private long compProdGqidTouchlessId;

	@Column(nullable = true)
	private String compProdGqidTouchlessMongoId;
