...
//		File fileName= new File(path+checkId+".zip");
		FileOutputStream fos = new FileOutputStream(path+checkId+".zip");
		ZipOutputStream zipOut = new ZipOutputStream(fos);
...
//			zipOut.putNextEntry(zipEntry);
	...
	public static void zipDirectory(String directoryLocation, String outputPath, String fileName) throws IOException {
		File directoryPath = new File(directoryLocation);
		// List of all files and directories
		File[] fileList = directoryPath.listFiles();
		if(fileList!=null) {
			List<File> fileListNew = Arrays.asList(fileList);
			multipleFileZip(fileListNew, outputPath, fileName);
		}
	}
}
